...
{
    public class SecelPartnerDefaultDesignTimeDbContextFactory
        : IDesignTimeDbContextFactory<SecelPartnerDataContext>
    {
        public SecelPartnerDataContext CreateDbContext(string[] args)
        {
            ...
            DbContextOptionsBuilder<SecelPartnerDataContext> optionBuilder =
                new DbContextOptionsBuilder<SecelPartnerDataContext>();
