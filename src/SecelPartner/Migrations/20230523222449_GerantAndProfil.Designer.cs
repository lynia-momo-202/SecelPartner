...
namespace SecelPartner.UI.Migrations
{
    ...
    [Migration("20230523222449_GerantAndProfil")]
    partial class GerantAndProfil
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartenariatSecel.Core.Data.Gerant", b =>
                {
                    b.HasOne("SecelPartner.Core.Entities.ContratPartenariat", "ContratPartenariats")
                        .WithMany()
                        .HasForeignKey("ContratPartenariatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SecelPartner.UI.Areas.Identity.Data.SecelPartnerUIUser", "Users")
                        .WithMany()
