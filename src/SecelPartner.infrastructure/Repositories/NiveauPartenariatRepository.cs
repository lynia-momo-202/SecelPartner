...
{
    public class NiveauPartenariatRepository
        : GenericRepository<NiveauPartenariat>,
            INiveauPartenariatRepository
    {
        public NiveauPartenariatRepository(SecelPartnerDataContext Context)
            : base(Context) { }
